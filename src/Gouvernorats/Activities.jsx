...
,
  ...
  .catch((err) => console.error('Erreur chargement JSON :', err));
    ...
    const handleCategoryClick = (categoryData) => {
      console.log("Navigating to:", `/${gouvernoratName.toLowerCase()}/${categoryData.category.toLowerCase()}`);
      console.log("State being passed:", { gouvernoratName, gouvernoratData, categoryData });
  
      navigate(`/tunisie/${gouvernoratLabel.toLowerCase()}/${categoryData.category.toLowerCase()}/cat`, {
        state: {
    ...
    return (
      <div className="container-column">
        <div className="container-cat">
          ...
          <div><a href= {url} target="_blank">Métiers</a> </div>
                    ...
                    <div className="image-container-cat">
                      ...
                      <div className="overlay-cat">
                        <div className="overlay1-cat">
                          <p className="category-name-cat">{t(categoryGroup.category)}</p>
                        </div>
                      </div>
                    </div>
                  </div>
