...
const CountrySelector = ({ countries, onCountrySelect }) => {
  ...
  const renderFlagBackground = (country) => {
    switch (country.name) {
      case "Tunisia":
        return "bg-red-600";
      case "Egypt":
        return "bg-gradient-to-r from-red-600 via-white to-black";
      case "Algeria":
        return "bg-gradient-to-r from-green-600 to-white";
      case "Libya":
        return "bg-gradient-to-r from-red-600 via-black to-green-600";
      case "Morocco":
        return "bg-red-600";
      default:
        return "bg-gray-300";
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center bg-gradient-to-r from-cyan-600 to-emerald-400 text-white px-6 py-12 overflow-hidden">
      {/* Title */}
      ...
      <div className="relative flex justify-center items-center w-full h-[350px]">
        {countryEntries.map(([key, country], idx) => {
          ...
          const offset = (idx - selectedIndex) * 200; // spacing between neighbors
          ...
          return (
            <div
              ...
              className={`absolute w-72 h-80 p-6 rounded-2xl shadow-xl cursor-pointer transition-all duration-500 ease-in-out
                ${renderFlagBackground(country)}
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-lg text-gray-200">{country.nameAr}</p>
                </div>
                ...
                <div className="mt-6 flex items-center justify-between">
                  ...
                  <ChevronRight
                    className={`w-6 h-6 transition-transform ${
                      isSelected ? "translate-x-2 text-yellow-300" : "group-hover:translate-x-2"
                    }`}
                  />
                </div>
              </div>
